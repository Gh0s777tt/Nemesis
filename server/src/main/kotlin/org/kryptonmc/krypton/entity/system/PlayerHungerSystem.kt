...
class PlayerHungerSystem(private val player: KryptonPlayer) {
    ...
    // 20 is the default vanilla food level; overridable for tests (start hungry) via -Dkrypton.startFoodLevel=<n>.
    var foodLevel: Int = System.getProperty("krypton.startFoodLevel")?.toIntOrNull()?.coerceIn(0, 20) ?: 20
