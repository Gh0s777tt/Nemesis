...
object FoodHandler : ItemTimedHandler {
    ...
    const val MAX_FOOD_LEVEL: Int = 20
    ...
    override fun finishUse(player: KryptonPlayer, hand: Hand): UseItemResult {
        ...
        // Food level is clamped to the vanilla maximum; saturation never exceeds the current food level.
        player.foodLevel = minOf(MAX_FOOD_LEVEL, player.foodLevel + DUMMY_FOOD_LEVEL_INCREASE)
        player.foodSaturationLevel = minOf(player.foodLevel.toFloat(), player.foodSaturationLevel + DUMMY_SATURATION_LEVEL_INCREASE)
