...
object PacketRegistry {
    ...
    fun bootstrap() {
        ...
        registerOutbound<PacketOutOpenScreen>(0x2C)
        ...
        registerOutbound<PacketOutRemoveEntityEffect>(0x3B)
        registerOutbound<PacketOutResourcePack>(0x3C)
        registerOutbound<PacketOutRespawn>(0x3D)
        ...
        registerOutbound<PacketOutSetExperience>(0x52)
        ...
        registerOutbound<PacketOutPickupItem>(0x63)
        ...
        registerOutbound<PacketOutEntityEffect>(0x68)
